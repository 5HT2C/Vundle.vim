  ...
  if isdirectory(git_dir) || filereadable(expand(a:bundle.path().'/.git', 1))
    ...
    if current_origin_url != a:bundle.uri
      ...
      let cmd_parts = [
                  ...
                  \ g:vundle#git_executable.' submodule sync --recursive',
    ...
    let cmd = g:vundle#git_executable.' clone --depth 1 --recursive --shallow-submodules '.vundle#installer#shellesc(a:bundle.uri).' '.vundle#installer#shellesc(a:bundle.path())
    let initial_sha = ''
  endif
  return [cmd, initial_sha]
endf
